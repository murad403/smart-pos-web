            ...
            <div className="flex gap-2 mb-6">
                {["kitchen", "bar"].map((role) => (
                    <button
                        ...
                        className={`px-4 py-2 rounded-lg font-medium transition-all ${staffRole === role
            ...
            <div className="flex gap-2 mb-6 flex-wrap">
                {(["new", "processing", "completed"] as const).map((status) => (
                    <button
                        ...
                        className={`px-4 py-2 rounded-lg font-medium transition-all ${orderStatus === status
                            ? "bg-gray-800 text-white"
                            : "bg-gray-200 text-gray-700 hover:bg-gray-300"
                            }`}
                    >
            ...
            <div className="space-y-4">
                {filteredOrders.length === 0 ? (
                    ...
                    filteredOrders.map((order) => (
                        <div key={order.id} className={`border-l-4 rounded-lg shadow-sm ${order.status === "new"
